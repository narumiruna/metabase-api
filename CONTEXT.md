...
- `metabaseapi.cli_commands` 下的 `actions_commands.py`、`automagic_commands.py`、`api_key_commands.py`、`agent_commands.py`、`alerts_comments_commands.py`、`analytics_commands.py`、`catalog_commands.py`、`platform_bug_reporting_commands.py`、`platform_cache_commands.py`、`platform_channel_commands.py`、`platform_cloud_migration_commands.py`、`data_studio_commands.py`、`dashboard_commands.py` 提供命令實作，legacy root-level shim 已移除。
